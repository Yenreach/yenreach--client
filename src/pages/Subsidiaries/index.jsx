...
const Subsidiaries = () => {
  return (
    <main id="main" className='pt-10 md:pt-20'>
        <Header />
        <Header />
        <section className='mt-2 px-4 md:px-8 py-12 bg-black/70 flex flex-col gap-3 text-white'>
            <h1 className="text-3xl font-extrabold text-white font-argentinum mb-3">Our Subsidiaries</h1>
            {/* <span className='font-bold'>Home / Contact Us</span> */}
        </section>
        <div className="px-4 md:px-8 pt-8">
            <section className="mb-20" id="dcl">
                <h2 className='text-green text-2xl font-bold mt-4 mb-2'>Dordorian Concept Limited</h2>
                <p className="mb-3">
                ...
                <h6 className='font-semibold mb-2'>Mission</h6>
                <p className="mb-3">
                ...
                <h6 className='font-semibold mb-2'>Vision</h6>
                <p className="mb-3">
                ...
                <h6 className='font-semibold mb-2'>Objectives</h6>
                <ul className="mb-3 list-disc pl-8 md:pl-12">
                ...
                <h6 className='font-semibold mb-2'>Value Proposition</h6>
                <ul className="mb-3 list-disc pl-8 md:pl-12">
                ...
                <h6>Address: <span className='font-medium'>58 Azikoro Road (Authentic Plaza), Opposite NUJ, Ekeki, Yenagoa Bayelsa State.</span></h6>
                <h6>Contact Us on: <span className='font-medium'>07037193301, 09024401562.</span></h6>
        </section>

        <section className="mb-20" id="btu">
                <h2 className='text-green text-2xl font-bold mt-4 mb-2'>Business and Technology (BusiTech) University (Coming Soon)</h2>
                <p className="mb-3">
                ...
                <h6>Administrative Address: <span className='font-medium'>58 Azikoro Road (Authentic Plaza), Opposite NUJ, Ekeki, Yenagoa Bayelsa State.</span></h6>
                <h6>Contact Us on: <span className='font-medium'>07037193301, 09024401562.</span></h6>
        </section>

        <section className="mb-20" id="bbm">

                <h2 className='text-green text-2xl font-bold mt-4 mb-2'>BYS Business Magazine</h2>
                <p className="mb-3">
                ...
                <h6 className='font-semibold mb-2'>Administrative Address: <span className='font-medium'>58 Azikoro Road (Authentic Plaza), Opposite NUJ, Ekeki, Yenagoa Bayelsa State.</span></h6>
                <h6 className='font-semibold mb-2'>Contact Us on: <span className='font-medium'>07037193301, 09024401562.</span></h6>
        </section>
        <section className="mb-20" id="bmc">
                <h2 className='text-green text-2xl font-bold mt-4 mb-2'>BusiTech Model College</h2>
                <h6 className='font-semibold mb-2'>Mission</h6>
                <p className="mb-3">
                ...
                <h6 className='font-semibold mb-2'>Why we exist?</h6>
                <ul className="mb-3 list-disc pl-8 md:pl-12">
                ...
                <h6 className='font-semibold mb-2'>Core Values</h6>
                <ul className="mb-3 list-disc pl-8 md:pl-12">
                <li>Creativity</li>
                <li>Exposure</li>
                <li>Excellence</li>
                ...
                <h6 className='font-semibold mb-2'>Motto: <span>Redefining Secondary School Education</span></h6>
                <h6>Address: <span className='font-medium'>58 Azikoro Road (Authentic Plaza), Opposite NUJ, Ekeki, Yenagoa Bayelsa State.</span></h6>
                <h6>Contact Us on: <span className='font-medium'>07037193301, 09024401562.</span></h6>
        </section>

        <section className="mb-20" id="tec">
                <h2 className='text-green text-2xl font-bold mt-4 mb-2'>TEC Industrial Park</h2>
                <p className="mb-3">
        ...
        <section className="mb-20" id="bgs">
                <h2 className='text-green text-2xl font-bold mt-4 mb-2'>BYS Graduate School</h2>
                <h6 className='font-semibold mb-2'>Mission</h6>
                <p className="mb-3">
        ...
        <section className="mb-20" id="de">
            <div className="row mb-5 container" data-aos="fade-up">
            <div className="">
                <h2 className='text-green text-2xl font-bold mt-4 mb-2'>Dordorian Estate</h2>
                <h6 className='font-semibold mb-2'>Mission</h6>
                <p className="mb-3">
