...
import { apiGetAllCategories, apiGetAllLGAs, apiGetAllStates } from '/src/services/CommonService'
...
const index = ({ setStep, businessData, setBusinessData, handleBusinessData}) => {
    ...
    const { data: lgas } = useFetch({
        api: apiGetAllLGAs,
        key: ['lgas', businessData?.stateId],
        param: {
            id: businessData?.stateId
        },
        enabled: !!businessData?.stateId,
    })
    ...
    <form action="" className='p-8 px-4 bg-white sm:px-8 rounded-2xl' onSubmit={handleSubmit}>
            ...
            <div className='w-full mb-8'>
                ...
                <select onChange={(e) => {
                    // setStateId(e.target.value)
                      handleBusinessData({target: { name: "stateId", value: e.target.value }})
                }} required className='w-full px-4 py-3 border-2 rounded-lg outline-none cursor-pointer bg-inherit focus:invalid:border-red-400 border-green' name="stateId" id="stateId" placeholder='Enter state'>
        ...
        <div className='justify-between mb-8 md:flex gap-9'>
            <div className='w-full mb-8'>
                ...
                <select required={true} value={businessData?.monthStarted} onChange={handleBusinessData} className='w-full px-4 py-3 border-2 rounded-lg outline-none cursor-pointer bg-inherit focus:invalid:border-red-400 border-green' name="monthStarted" id="monthStarted" placeholder='Enter your business start Month'>
            ...
            <div className='w-full '>
                ...
                <Input required={true} value={businessData?.yearStarted} onChange={handleBusinessData} className='rounded-lg border-gray' type="number" name="yearStarted" id="yearStarted" placeholder='Enter your business start Year' />
            </div>
        </div>
