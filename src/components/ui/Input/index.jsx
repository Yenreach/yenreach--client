...
function Input({type, id, className='',placeholder='', name, onChange, required }) {
  ...
  return (
    <input type={type} className={styles(className)} id={id} name={name} placeholder={placeholder} onChange={onChange} required={required} />
  )
