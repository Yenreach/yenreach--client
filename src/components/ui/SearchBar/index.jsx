...
function SearchBar({variant}){
	...
	variant === 'job' ? (
		<form action="" method="post" className='flex'>
			<Input variant='job' type="text" name="business" id="business" placeholder='business' className='rounded-tl-md rounded-bl-md' />
	...
	variant === 'product' ? (
		<form action="" method="post" className='flex'>
			<Input variant='product' type="text" name="business" id="business" placeholder='business' className='rounded-tl-md rounded-bl-md' />
