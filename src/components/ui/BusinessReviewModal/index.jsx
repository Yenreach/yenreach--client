    ...
    <div onClick={handleOutsideClick} className='backdrop-blur-[1.5px] bg-black/60 fixed top-0 left-0 w-full max-h-screen min-h-screen z-50 grid place-items-center overflow-hidden'>
        <div className="modal bg-white p-8 py-6 w-full max-w-md">
            ...
            <div className='py-2 pb-14 relative'>
                <textarea className='border-2 border-black/10 p-4 px-6 w-full text-xs opacity-80 outline-none focus:border-black/30 rounded-xl p-2' name="review" id="review" cols="40" rows="8" defaultValue={"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Faucibus at massa lobortis et consequat maecenas commodo. Pellentesque enim pulvinar magna interdum egestas sed quam nunc. In pr."}>
                </textarea>
