...
// import DECImg from '/src/assets/DEC_imageUrl.jpg'
                                    ...
                                    <div className="h-[90%] swiper-wrapper">
                                        {
                                            ...
                                            <div key={index} className="h-full swiper-slide">
                                                <div className='flex flex-col items-center justify-center w-full h-full gap-8 md:flex-row'>
                                                    <div className="flex-1 w-full h-full">
                                                        <img src={billboard?.imageUrl?.replace('mediatoken', 'media&token')} alt="advert-banner" className='w-full h-[250px] md:h-full object-contain carousel-img' />
                                                        {/* <img src={billboard?.imageUrl?.replace('mediatoken', 'media&token')} alt="advert-banner" className='w-full h-[250px] md:h-full object-fill carousel-img' /> */}
                                                    </div>
                                                    <div className="flex flex-col items-center justify-center flex-1 w-full h-full gap-4 text-center">
                                                        <h2 className="text-xl text-black lg:text-3xl text-capitalize text-bold">{billboard?.title}</h2>
                                                        <p className="max-w-[400px] text-center mb-6 text-sm lg:text-base text-black/70">
                                                        ...
                                                        <a href={billboard?.ctaLink} target="_blank" className="px-4 py-2 text-sm text-white rounded bg-green">{billboard?.ctaText}</a>
                                                    </div>
                                                </div>
                                            </div>

                                            // <div key={index} className="swiper-slide">
                                            //     <img width={100} height={100} src={billboard.imageUrl} alt="advert-banner" className='w-full h-full bg-cover rounded-md' />
                                            // </div>
                                            )
                                        }
                                    </div>
