    ...
    <>
      <header className='bg-white shadow-md flex items-center justify-between py-2 px-4 md:py-5 md:px-10 lg:px-24 fixed top-0 left-0 z-10 w-full min-h-[50px] right-0'>
        <Link to={"/"}>
          ...
          {/* <img src={Logo2} alt="" className='h-4 my-2 md:my-3 md:w-36 w-28 md:h-5' /> */}
        </Link>
        ...
        <div className={`md:hidden shadow fixed top-0 right-0 w-5/6 min-h-screen h-screen bg-white px-4  py-2 md:px-10 z-30 ${isOpen ? "translate-x-0" : "translate-x-full"} z-50 transition-all duration-300`}>
