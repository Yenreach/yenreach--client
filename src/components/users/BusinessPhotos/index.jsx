...
const index = () => {
  return (
    <form className='p-8 px-4 sm:px-8 bg-white rounded-2xl'>
        ...
        <p htmlFor="business_name" className='font-medium text-sm'>Upload the cover and profile picture of your business</p>
        <p>Note: You can only upload images in png, Jpeg format and they must be less than 4mb in size</p>
        <div className='mb-8'>
            <p htmlFor="business_name" className='font-medium text-sm'>Upload the cover and profile picture of your business</p>
